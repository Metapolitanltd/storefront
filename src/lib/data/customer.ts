...
/**
 * Update the customer's profile. Email and password are owned by Vero's hosted
 * account UI and cannot be changed from the storefront; name, phone, and
 * metadata (e.g. a wholesale applicant's company) are stored on the Spree
 * customer record.
 */
