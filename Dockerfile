...
# Vero hosted-login config is read by server routes at runtime. Keep the
# non-secret public gateway settings in the image so Next standalone has them.
ARG NEXT_PUBLIC_VERO_BASE_URL=""
ARG NEXT_PUBLIC_VERO_AUTH_CB=""
...
ENV NEXT_PUBLIC_VERO_BASE_URL=$NEXT_PUBLIC_VERO_BASE_URL \
    NEXT_PUBLIC_VERO_AUTH_CB=$NEXT_PUBLIC_VERO_AUTH_CB \
